package com.darly.snbc.adieas.common.bolts.tasks;
...
import com.darly.snbc.adieas.common.bolts.tasks.bean.Capture;
import com.darly.snbc.adieas.common.bolts.tasks.exception.AggregateException;
import com.darly.snbc.adieas.common.bolts.tasks.exception.ExecutorException;
import com.darly.snbc.adieas.common.bolts.tasks.exception.UnobservedTaskException;
import com.darly.snbc.adieas.common.bolts.tasks.iface.Continuation;
...
public class Task<TResult> {
  ...
  /**
   * @deprecated Please use {@link TaskCompletion()} instead.
   */
  ...
  public static <TResult> Task<TResult> forResult(TResult value) {
    ...
    TaskCompletion<TResult> tcs = new TaskCompletion<>();
    tcs.setResult(value);
    return tcs.getTask();
  }
  ...
  /* package */ static Task<Void> delay(long delay, ScheduledExecutorService executor, final CancellationToken cancellationToken) {
    ...
    final TaskCompletion<Void> tcs = new TaskCompletion<>();
  ...
  public static <TResult> Task<TResult> call(final Callable<TResult> callable, Executor executor,
    ...
    final TaskCompletion<TResult> tcs = new TaskCompletion<>();
    try {
  ...
  public static <TResult> Task<Task<TResult>> whenAnyResult(Collection<? extends Task<TResult>> tasks) {
    ...
    final TaskCompletion<Task<TResult>> firstCompleted = new TaskCompletion<>();
  ...
  public static Task<Task<?>> whenAny(Collection<? extends Task<?>> tasks) {
    ...
    final TaskCompletion<Task<?>> firstCompleted = new TaskCompletion<>();
    final AtomicBoolean isAnyTaskComplete = new AtomicBoolean(false);
  ...
  public static Task<Void> whenAll(Collection<? extends Task<?>> tasks) {
    ...
    final TaskCompletion<Void> allFinished = new TaskCompletion<>();
  ...
  public <TContinuationResult> Task<TContinuationResult> continueWith(
      ...
      final CancellationToken ct) {
    boolean completed;
    final TaskCompletion<TContinuationResult> tcs = new TaskCompletion<>();
    synchronized (lock) {
  ...
  private static <TContinuationResult, TResult> void completeImmediately(
      final TaskCompletion<TContinuationResult> tcs,
   ...
   * @deprecated Please use {@link TaskCompletion} instead.
   */
  public class TaskCompletionSource extends TaskCompletion<TResult> {
